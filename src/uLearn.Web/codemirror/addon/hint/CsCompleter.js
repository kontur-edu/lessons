function CsCompleter(keywords) {
	...
	this.types = ['int', 'string', 'double', 'Console', 'Math', 'long', 'Boolean', 'double', 'Enumerable', 'Array', 'Enumerable'];
	...
	this.dictWithNonStaticMethods['Enumerable'] = ['Add', 'AddRange', 'AsReadOnly', 'BinarySearch', 'Clear', 'Contains', 'ConvertAll', 'CopyTo', 'Find', 'FindAll', 'FindIndex', 'ForEach', 'GetEnumerator', 'GetRange', 'IndexOf', 'Insert', 'InsertRange', 'Remove', 'RemoveAll', 'RemoveAt', 'RemoveRange', 'Reverse', 'Sort', 'ToArray', 'TrimExcess', 'Exists', 'FindLast', 'FindLastIndex', 'LastIndexOf', 'TrueForAll', 'ToString', 'Equals', 'GetHashCode', 'GetType'];
	...
	this.dictWithProperties['Enumerable'] = ['Capacity', 'Count', 'Item'];
	...
	this.returnTypeDict['string'] = ['Join', 'Format', 'Copy', 'Concat', 'Intern', 'IsInterned', 'ReadLine', 'ToString', 'Substring', 'Trim', 'TrimStart', 'TrimEnd', 'Normalize', 'PadLeft', 'PadRight', 'ToLower', 'ToLowerInvariant', 'ToUpper', 'ToUpperInvariant', 'Insert', 'Replace', 'Remove', 'Title', 'Empty', 'TrueString', 'FalseString'];
