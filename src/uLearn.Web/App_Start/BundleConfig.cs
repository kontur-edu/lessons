	...
	public class BundleConfig
	{
		...
		private static Bundle CssBundle()
		{
			return new StyleBundle("~/ulearn.bundle.css").Include(
				...
				"~/Content/login_and_registration.css",
				"~/Content/course_versions.css",
				"~/Content/analytics.css",
				"~/Content/code_review.css",
				"~/Content/certificates.css",
				"~/Content/course_statistics.css",
				"~/Content/notification_settings.css",
